...
// AddWizardFlags binds the shared TUI flags to the command's option struct.
func AddWizardFlags(cmd *cobra.Command, o *Options) {
...
func WizardCommands() []*cobra.Command {
	...
	initCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return RunInit(dir, *initOpts)
		},
	}
	AddWizardFlags(initCmd, initOpts)
	...
	editCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return RunEdit(".", slug, *editOpts)
		},
	}
	AddWizardFlags(editCmd, editOpts)
	...
	menuCmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return RunMenu(".", *menuOpts)
		},
	}
	AddWizardFlags(menuCmd, menuOpts)
